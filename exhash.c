...
int ΕH_CreateIndex(char *fileName, char* attrName, char attrType, int attrLength, int depth) {
	HT_info info;
	void *block;
	int i, *index, counter;
...
ΕH_info* ΕH_OpenIndex(char *fileName) {
	HT_info *info;
	void *block;
...
int ΕH_CloseIndex(ΕH_info* header_info) {
...
int ΕH_InsertEntry(ΕH_info* header_info, Record record) {
...
int ΕH_GetAllEntries( ΕH_info header_info, void *value) {
    /* Add your code here */
