...
ΕH_info* ΕH_OpenIndex( char *fileName );                       /* όνομα αρχείου προς άνοιγμα */
...
int ΕH_CloseIndex( ΕH_info* header_info );         /* πληροφορίες του αρχείου προς κλείσιμο */ 
...
int ΕH_InsertEntry(
    ΕH_info* header_info,                                         /* επικεφαλίδα του αρχείου*/ 
